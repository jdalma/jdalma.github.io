...
2. [`Junit5` user guide](https://junit.org/junit5/docs/current/user-guide/)
   ...
   - [`johngrib` JUnit5로 계층 구조의 테스트 코드 작성하기](https://johngrib.github.io/wiki/junit5-nested/)
3. **AssertJ**
...
5. **Spring Test**
   - [`Spring docs` Testing](https://docs.spring.io/spring-framework/docs/current/reference/html/testing.html)
