...
<img src="../../assets/images/retrospective/testcode.png" width="300px" height="500px">
...
<img src="../../assets/images/retrospective/flow.png" width="700px" height="300px">
...
이번 트레이닝 프로젝트는 좋은 경험이였지만 기술적인 키워드들이 너무 많이 포함되어 있었어서 힘들었다.    
스스로 테스트 케이스를 생각하며 테스트하고 어디를 더 조사해야할지 결정하여 힘들었지만 힘든만큼 재밌기도 했지만 무기력감을 많이 느낀 것 같다.  
`"시간만 있다면 스스로 어떤 일이든 해낼 수 있다"` 라고 생각하고 있었지만 스스로 돌아보는 계기가 되었다.  
원리를 이해하기 위한 학습을 계속 해야하고, 이번에 Armeria와 gRPC를 사용하는 만큼 비동기 프로그래밍과 HTTP/2는 확실하게 짚고가자  
