...
# 📝 **`[LeetCode] DP` [Paint House](https://leetcode.com/problems/paint-house/)** ⚡️
...
## Second Approach, Memoization - <span class="text-green-300">Success</span>
...
# **`[2021카카오] 다익스트라` [합승 택시 요금](https://programmers.co.kr/learn/courses/30/lessons/72413)**
