...
# **`[백준] Dijkstra - 기초문제` [최단거리](https://www.acmicpc.net/problem/1753)**
...
# **`[백준] Floyd Warshall - 모든 정점에서 모든 정점으로의 최단 경로` [경로찾기](https://www.acmicpc.net/problem/11403)**
...
# **`[백준] BFS` [구슬탈출](https://www.acmicpc.net/problem/13459)** ❌

- 4 방향으로 기울이며 빨간 구슬을 구멍으로 빼내는 문제
  - 벽을 만날 때 까지 진행
- 빨간 구슬과 파란 구슬은 같은 위치에 있을 수 없으며 동시에 움직인다.
- 파란 구슬이 빠지면 실패
...
# **`[백준] 수학` [골드바흐의 추측](https://www.acmicpc.net/problem/6588)**
...
# **`[백준] 브루트 포스` [일곱 난쟁이](https://www.acmicpc.net/problem/2309)**
...
# **`[백준] 브루트 포스` [날짜 계산](https://www.acmicpc.net/problem/1476)**
...
# **`[백준] 브루트 포스` [연산자 끼워넣기2](https://www.acmicpc.net/problem/15658)**
...
# **`[백준] 브루트 포스` [로또](https://www.acmicpc.net/problem/6603)**
...
# 🔥 **`[백준] 브루트 포스` [퇴사](https://www.acmicpc.net/problem/14501)** 📝
...
# **`[백준] 그래프` [상근이의 여행](https://www.acmicpc.net/problem/9372)**
...
# **`[백준] 그래프` [양치기 꿍](https://www.acmicpc.net/problem/3187)**

- BFS 문제
  - 입력 받을 시 미리 모든 양과 늑대의 수를 확인
  - 4방향 방문 체크 후 울타리 지역 내부의 양과 늑대의 수를 비교하여 **static 변수** 양의 수와 늑대의 수를 감소시킨다.
