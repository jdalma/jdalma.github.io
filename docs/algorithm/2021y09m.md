...
public class Main {
    static int[] symbolArr = new int[11];
    static int[] numArr;
    static int[] printArr;
    static boolean[] checked;
...
//            System.out.println("result = " + number);
            ...
            if(number != 0) min = Math.min(number, min);
        }
        else{
            for(int i = 0 ; i < numArr.length ; i++) {
                if(!checked[i]){
                    ...
                    switch(symbolArr[i]){
                        case 1:
                            resultValue = number + numArr[index];
                            System.out.print("+");
                            break;
                        case 2:
                            resultValue = number - numArr[index];
                    ...
                    checked[i] = true;
                    System.out.println(numArr[index] + " = " + resultValue);
                    recursive(index + 1 ,count + 1 , resultValue);
                }
            }
        }
        checked[index] = false;
...
# **`[백준] BFS` [연결 요소의 개수](https://www.acmicpc.net/problem/11724)**
...
# **`[백준] BFS` [섬의 개수](https://www.acmicpc.net/problem/4963)**
...
# **`[백준] BFS` [토마토](https://www.acmicpc.net/problem/7569)**
...
# **`[백준] DFS` [트리의 부모 찾기](https://www.acmicpc.net/problem/11725)**
...
# **`[백준] DFS` [ABCDE](https://www.acmicpc.net/problem/13023)**
...
# **`[백준] BFS` [양](https://www.acmicpc.net/problem/3184)**
...
# **`[백준] DFS` [다음 순열](https://www.acmicpc.net/problem/10972) ❌**
...
# **`[백준] DFS` [모든 순열](https://www.acmicpc.net/problem/10974)**
...
# **`[백준] BFS` [나이트의 이동](https://www.acmicpc.net/problem/7562)**
...
# **`[백준] BFS` [A->B](https://www.acmicpc.net/problem/16953)**
...
# **`[백준 BFS]` [촌수계산](https://www.acmicpc.net/problem/2644)**
...
# 🔥 **`[백준 BFS]` [숨바꼭질3](https://www.acmicpc.net/problem/13549)**
...
# **`[백준 BFS]` [숨바꼭질4](https://www.acmicpc.net/problem/13913)**
