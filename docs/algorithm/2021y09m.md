...
# 🔥 **`[백준] Next Permutation을 구현하는 문제` [다음 순열](https://www.acmicpc.net/problem/10972) 📝**

- [참고](https://pangtrue.tistory.com/327)
...
# **`[백준] BFS?DFS?` [최단거리](https://www.acmicpc.net/problem/1753) 진행중**
    ...
    public static void bfs(int stanVertex , int vertexSize){
        ...
        while(!queue.isEmpty()){
            ...
            for(int i = 1 ;  i <= vertexSize ; i++){
                if(!checked[nowVertex][i] && map[nowVertex][i] != Integer.MAX_VALUE){
