...
# **`[백준 Implementation]` [문제 추천 시스템 Version 1](https://www.acmicpc.net/problem/21939)**
...
class Main {
    ...
    static PriorityQueue<Problem> asc = new PriorityQueue<Problem>(Comparator.comparing(Problem::getLevel).thenComparing(Problem::getNo));
    static PriorityQueue<Problem> desc = new PriorityQueue<Problem>(Comparator.comparing(Problem::getLevel).thenComparing(Problem::getNo).reversed());
    static PriorityQueue<Problem> removeProblem = new PriorityQueue<Problem>(Comparator.comparing(Problem::getLevel).thenComparing(Problem::getNo));
    static boolean[] solved = new boolean[100001];
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(System.out));
        ...
        for(int i = 0 ; i < problemCount ; i++){
            ...
            desc.offer(new Problem(no , level));
            asc.offer(new Problem(no , level));
        }
        ...
        for(int i = 0 ; i < commandCount ; i++){
            ...
            switch(command){
                ...
                case "add" :
                    ...
                    desc.offer(new Problem(firstParam , level));
                    asc.offer(new Problem(firstParam , level));         
                    solved[firstParam] = false;
                    break;
                case "solved" :
                    problems.remove(firstParam);
                    solved[firstParam] = true;
                    break;
            }
        }
