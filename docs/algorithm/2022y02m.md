        ...
        for(int i = 0 ; i < commandCount ; i++){
            ...
            switch(command){
                ...
                case "add" :
                    ...
                    levels.get(level).add(firstParam);
                    break;
                case "solved" :
                    levels.get(problems.get(firstParam)).remove((Object) firstParam);
        ...
        if(param > 0){
            for(int i = levels.size() - 1 ; i >= 0 ; i--){
                if(levels.get(i).size() > 0){
                    return String.valueOf(levels.get(i).stream()
                                                        .mapToInt(no -> no)
                                                        .max()
