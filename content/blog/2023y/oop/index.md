...
좋은 코드라고 판단하지 못하고, 좋은 코드를 작성하지 못하는 이유는 **어떤 코드가 고품질의 코드인지 알지 못하기 때문이다.**  
...
인터페이스에 기본 메서드가 추가되고 정적 변수를 추가할 수 있게 되면서 추상 클래스의 대부분의 기능을 따라할 수 있게 됐다.  
...
그리고 이런 내용을 배웠다고 해서 팀내 컨벤션을 고려하지 않고 팀원들과 충분한 협의 없의는 강요해서는 안될 것이다.  
