...
1. 화면을 몇 개 완성했는지, 1년에 몇 개의 프로젝트를 완료했는지 등 속도가 주 목표
2. 주 업무는 정부과제, 공공기관 대상으로 개발만하고 빠지는 구조로 운영 업무를 통한 피드백을 경험할 수 없는 환경

생각해보면 아쉬운 점도 많다
1. 사내 인트라넷이 형상관리가 안되고 있었는데 Git으로 도전해볼껄
2. 마지막 프로젝트에서 REST API를 적용해보면서 API문서화를 적용해볼껄
3. 사내 동료들과 책 스터디를 할껄
4. TDD를 일찍 배워서 실무에 스스로 적용해볼껄
